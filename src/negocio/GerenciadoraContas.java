...
public class GerenciadoraContas {
	 ...
	 */
	public boolean transfereValor (int idContaOrigem, double valor, int idContaDestino, double valorLimite) {
		...
		if (contaOrigem.getSaldo() >= valor || (valorLimite > 0 && valorLimite >= valor)){
